...
# Adapted from
# https://github.com/vllm-project/vllm/blob/v0.8.3/vllm/attention/backends/flash_attn.py
#
...
class MsAttentionMetadata(AttentionMetadata):
    ...
    def advance_step(self,
        ...
        advance_step_op(sampled_token_ids, model_input, self.seq_lens_tensor,
                        num_queries, block_size, self.block_tables,
                        self.slot_mapping)
