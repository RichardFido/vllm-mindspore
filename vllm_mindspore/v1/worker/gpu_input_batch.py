...
def input_batch_init(
    ...
    self.num_computed_tokens_cpu_tensor = convert_pin(self.num_computed_tokens_cpu_tensor)
    ...
    self.frequency_penalties_cpu_tensor = torch.empty(
        ...
        device="cpu",
        pin_memory=pin_memory)
    self.frequency_penalties_cpu_tensor = convert_pin(self.frequency_penalties_cpu_tensor)
    ...
    self.presence_penalties_cpu_tensor = torch.empty((max_num_reqs, ),
                                                     ...
                                                     device="cpu",
                                                     pin_memory=pin_memory)
    self.presence_penalties_cpu_tensor = convert_pin(self.presence_penalties_cpu_tensor)
    ...
    self.repetition_penalties_cpu_tensor = torch.empty(
        ...
        device="cpu",
        pin_memory=pin_memory)
    self.repetition_penalties_cpu_tensor = convert_pin(self.repetition_penalties_cpu_tensor)
    ...
    self.num_accepted_tokens_cpu_tensor = convert_pin(self.num_accepted_tokens_cpu_tensor)
    # vllm-mindspore end
